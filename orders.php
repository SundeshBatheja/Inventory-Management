...
<div class = "col-lg-10 m-auto d-block">
  <form action= "uploadOrders.php" method= "post" enctype="multipart/form-data">
  <div class = "form-group">
        <label for = "text">Order Date</label> 
          <input type="text" name="date" placeholder ="yyyy-mm-dd" id = "user" class = "form-control">
  </div><br>
    <div class = "form-group">
        <label for = "text">Customer Name</label> 
          <input type="text" name="name"  id = "user" class = "form-control">
    </div><br>
    <input type="submit" name = 'submit' value = "Insert Order" class="btn btn-dark">
    &emsp;&emsp;
    <input type="submit" name = 'unsubmit' value = "Show Orders" class="btn btn-dark">
  </form>
  <?php
echo "<br>";
        if (isset($_GET["msg"]) && $_GET["msg"] == 'success') {
          echo '<b>Order Added Successfully!</b>';
